...
<body>
	<h4>商品管理>>商品入库</h4>
	<div>
		<form action="GoodsInStorage" mothod="GeT">
			...
			商品编号:<input type="text" name="goodsID" id="goodsID" /><br /> 商品价格:<input
				...
				type="submit" name="subimt" id="submit" value="入库" />
		</form>
	</div>
	<hr width="600px" />
	<c:if test="${requestScope.Goods==53}">
		<div class="page3" id="goods">
			...
			<div
				...
				<table id="table" border="1" align="center" width="600px">
					...
					<c:forEach items="${requestScope.list53}" var="info" varStatus="vst">
						<tr align="center" height="20px">
						    <td>${vst.index+1}</td>
