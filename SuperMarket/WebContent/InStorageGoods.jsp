...
<body>
	...
	<c:if test="${requestScope.Goods==03}">
		<div class="page3" id="inStorageGoods">
			<h4>商品>>进库商品</h4>
			<div
				...
				<table id="table" border="1" align="center" width="600px">
					...
					<c:forEach items="${requestScope.list43}" var="info" varStatus="vst">
						<tr align="center" height="20px">
						    <td>${vst.index+1}</td>
		    ...
		    <h3>进库商品总价格：${requestScope.money}元</h3>
		</div>
	</c:if>
</body>
</html>