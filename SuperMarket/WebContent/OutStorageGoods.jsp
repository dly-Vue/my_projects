...
<body>
	<c:if test="${requestScope.Goods==02}">
		<div class="page3" id="outStorageGoods">
			<h4>商品>>出库商品</h4>
			<div
				...
				<table id="table" border="1" align="center" width="600px">
					...
					<c:forEach items="${requestScope.list42}" var="info" varStatus="vst">
						<tr align="center" height="20px">
						    <td>${vst.index+1}</td>
		    ...
		    <h3>出库商品总价格：${requestScope.money}元</h3>
		</div>
	</c:if>
